...
void GL_init(int nArgs, char ** arg)
{
   ...
   // CHECK FREE RAM
   // If a program uses a lot of RAM, it's useful to know how much we have to use.
   // Stolen from https://msdn.microsoft.com/en-us/library/windows/desktop/aa366589%28v=vs.85%29.aspx
#define OUTPUT_SYSTEM_SPECS
#ifdef OUTPUT_SYSTEM_SPECS
   ...
   const char * str2 = (const char*)glGetString(GL_EXTENSIONS);
   std::cout<<"Supported extensions: "<<str2<<"\n";
