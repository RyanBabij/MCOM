...
unsigned short int PROGRAM_CYCLES_PER_TICK = 1;
  ...
  // SYSTEM STRINGS
const std::string VERSION = "1.0.000 Win32";
...
int UANIMATIONSPERSECOND = 1000000/ANIMATION_PER_SECOND;
unsigned long int  CURRENT_ANIMATION_FRAME = 0;

void SET_ANIMATION_SPEED(double animPerSecond)
{
   ANIMATION_PER_SECOND=animPerSecond;
   UANIMATIONSPERSECOND = 1000000/ANIMATION_PER_SECOND;
}
